...
abstract class AppLocalizations {
  ...
  /// No description provided for @home_body_title.
  ///
  /// In en, this message translates to:
  /// **'Shortcut'**
  String get home_body_title;

  /// No description provided for @home_input_label.
  ///
  /// In en, this message translates to:
  /// **'url'**
  String get home_input_label;
  ...
  /// No description provided for @home_input_hint.
  ///
  /// In en, this message translates to:
  /// **'Insert url'**
  String get home_input_hint;

  /// No description provided for @home_send_url_error.
  ///
  /// In en, this message translates to:
